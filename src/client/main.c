...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        if (strcmp(command, "connect") == 0) {
            ...
            mvwprintw(input_board_win, 2, 0, "input your name: ");
            wgetstr(input_board_win, username);

            mvwprintw(input_board_win, 3, 0, "input your password: ");
